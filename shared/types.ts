...
export type Task = { id: string, project_id: string, title: string, description: string | null, status: TaskStatus, parent_task_attempt: string | null, repo_path: string | null, executor_profile_id: ExecutorProfileId | null, created_at: string, updated_at: string, };

export type TaskWithAttemptStatus = { id: string, project_id: string, title: string, description: string | null, status: TaskStatus, parent_task_attempt: string | null, repo_path: string | null, executor_profile_id: ExecutorProfileId | null, created_at: string, updated_at: string, has_in_progress_attempt: boolean, has_merged_attempt: boolean, last_attempt_failed: boolean, executor: string, };

export type CreateTask = { project_id: string, title: string, description: string | null, parent_task_attempt: string | null, repo_path: string | null, executor_profile_id: ExecutorProfileId | null, image_ids: Array<string> | null, };

export type UpdateTask = { title: string | null, description: string | null, status: TaskStatus | null, parent_task_attempt: string | null, repo_path: string | null, executor_profile_id: ExecutorProfileId | null, image_ids: Array<string> | null, };
...
export type ClaudeBrowserChat = null;

export type M365CopilotChat = null;
...
export type BrowserChatRequest = { message: string, agent_type: BrowserChatAgentType, executor_profile_id: ExecutorProfileId, 
/**
